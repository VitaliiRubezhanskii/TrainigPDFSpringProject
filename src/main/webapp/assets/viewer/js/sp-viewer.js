...
sp.viewer = {
  ...
  setCustomerEvent: function(eventData) {
    ...
    $.ajax({
      url: ViewerConfiguration.API_URL + '/ManagementServlet',
      method: 'POST',
...
if ('' != sp.viewer.linkHash) {
  $.get('../../v1/viewer-configuration').done(function(data) {
    ViewerConfiguration = {};
    Object.defineProperty(ViewerConfiguration, 'API_URL', {
      value: data.apiUrl,
      writable: false
    });
    
    $.ajax({
      url: ViewerConfiguration.API_URL + '/config-viewer',
