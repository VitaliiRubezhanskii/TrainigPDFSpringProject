                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <p class="lead">This is an automated <b>Alert</b> generated by SlidePiper.</p>
								  <p class="lead"><b>This document is being viewed now:</b></p>
                  <p>Your document has been opened</p>
                    <p>Document Name: ${documentName!}</p>
  								  <p>Client Name: ${customerName!"Generic Link"} </p>
                    <p>Client Email: ${customerEmail!}</p>
