                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0;">
                            ...
                            <div style="text-align: center;"><span style="font-size:25px;">SlidePiper Report Email</span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px; text-align: center;">               
                            <span style="font-size:12px"><small>This is an automated report generated by SlidePiper.</small>&nbsp;
                            <small>Please do not reply to this email.</small>&nbsp;<br>
                            <small>To stop receiving these emails, go to: 
                            <br><a href="www.slidepiper.com/dashboard.html">SlidePiper Dashboard</a>&nbsp;&gt; Settings &gt; Document Settings<br>uncheck 'Enable Report Emails'</small></span>
                        </td>
                    </tr>
                </tbody></table>
        <!--[if mso]>
