                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <h1 class="text-center">SlidePiper Document Report</h1>
								  <table class="spacer">
                                    <tbody>
                                      <tr>
                                        <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
                                  ...
                                  <p class="lead">This is an automated report generated by SlidePiper.</p>
								  <p class="lead"><b>${documentName!} has been viewed</b></p>
								  <p><a href="http://www.slidepiper.com/login.html">Go to dashboard</a></p>
                                  <p><b>Highlights</b></p>              
  								  <p>Client: ${customerName!"Generic Link"} (${customerEmail!})</p>
                    <p>Time opened: ${openTime!}</p>
  								  <p>Is mobile device: ${device!}</p>
                                      ...
                                      <tr>
                                        <th class="small-12 large-6 columns first">
                                          <table>
                                            <tr>
                                              <th>
                                                <h4>Qustions asked:</h4>
                                                <ul>
                                                  <li><a href="#">page |page number|: |Question|</a></li>
                                                  <li><a href="#">page |page number|: |Question|</a></li>
                                                  <li><a href="#">page |page number|: |Question|</a></li>
                                                </ul>
                                              </th>
