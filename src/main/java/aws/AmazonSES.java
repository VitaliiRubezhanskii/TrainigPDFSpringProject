...
public class AmazonSES {
	...
	static final String FROM = ConfigProperties.getProperty("amazon_default_from_email");   
    ...
    public static void setEmailParams(String[] notificationData, Map<String, String> eventDataMap) {
		...
		switch(eventDataMap.get("eventName")) {
			case "VIEWER_WIDGET_ASK_QUESTION":
				...
				emailParams.put("messageText", eventDataMap.get("param_2_varchar"));
				emailParams.put("messageReplyEmail", eventDataMap.get("param_3_varchar"));
				break;
		}
