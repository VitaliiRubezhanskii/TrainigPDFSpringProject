...
public class DashboardUserController {
    ...
    public void saveEmailConfiguration(Principal principal,
        ...
        viewer.setViewerSupportMailEnabled(userEmailConfigurationInput.isShownNotificationMail());
    ...
    public Map<String, Object> userConfiguration(Principal principal) {
        ...
        userConfiguration.put("email_support_show_alert_enabled",viewer.isViewerSupportMailEnabled());
